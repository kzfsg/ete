---
name: ete
description: Use when asked to build, add, record, run, fix, or debug end-to-end (E2E) browser tests or "user flows" with ete, when a request like "/ete build 3 user flows from login to checkout" arrives, or when a CI "ete E2E results" PR comment reports failed, healed, or anomalous steps. Covers explore → run → review → commit and how results appear on the PR.
---
