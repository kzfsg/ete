---
name: ete-author
description: Use when asked to add, write, fix, run, or debug end-to-end (E2E) browser tests with ete, or when a CI "ete E2E results" comment reports healed or failed steps. Covers the author → run → review → commit loop and the natural-language step format.
---
